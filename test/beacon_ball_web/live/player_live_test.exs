defmodule BeaconBallWeb.PlayerLiveTest do
  use BeaconBallWeb.ConnCase

  import Phoenix.LiveViewTest
  import BeaconBall.PeopleFixtures

  @create_attrs %{is_admin: true, name: "some name", phone_number: 42}
  @update_attrs %{is_admin: false, name: "some updated name", phone_number: 43}
  @invalid_attrs %{is_admin: false, name: nil, phone_number: nil}
